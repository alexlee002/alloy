 ...
 */
extern YYEncodingType YYEncodingGetType(const char *typeEncoding);
...
@property (nonatomic, assign, readonly, nullable) Class         superCls;   ///< super class object
@property (nonatomic, assign, readonly, nullable) Class         metaCls;    ///< class's meta class object
