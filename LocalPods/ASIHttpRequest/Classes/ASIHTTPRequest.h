...
typedef enum _ASINetworkErrorType {
	...
	ASIDownNotEqualContentLenght=12
} ASINetworkErrorType;
...
- (void)setUserAgent:(NSString *)userAgentStr;
...
//add by chenzhibo
//reson: 循环拉取消息，系统菊花一直转动,体验不好
@property (assign) BOOL needHiddenIndicator;
@property (retain, nonatomic) NSInputStream *readStream;
@property (assign, nonatomic) BOOL readStreamIsScheduled;
@property (assign, nonatomic) BOOL needParseResponseAsynchronous;
@end
